...
<?php echo $this->Form->create('EntryCategory'); ?>
	...
	<?php
		...
		echo $this->Form->input('EntryCategory.0.applies_hold_pt', array('label' => '残留ポイント適用有無', 'checked' => true));
		echo $this->Form->input('EntryCategory.0.applies_rank_up', array('label' => '昇格有無', 'checked' => true));
		echo $this->Form->input('EntryCategory.0.applies_ajocc_pt', array('label' => 'AJOCC ポイント配点有無', 'checked' => true));
