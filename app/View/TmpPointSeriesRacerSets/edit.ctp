...
<?php echo $this->Form->create('TmpPointSeriesRacerSet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tmp Point Series Racer Set'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TmpPointSeriesRacerSet.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('TmpPointSeriesRacerSet.id')))); ?></li>
