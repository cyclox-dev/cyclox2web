<div class="entryGroups index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $entryGroup['EntryGroup']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $entryGroup['EntryGroup']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
