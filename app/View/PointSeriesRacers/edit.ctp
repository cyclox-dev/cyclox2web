...
<?php echo $this->Form->create('PointSeriesRacer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Point Series Racer'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('racer_code', array('label' => 'Racer Code', 'type' => 'text'));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PointSeriesRacer.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PointSeriesRacer.id'))); ?></li>
