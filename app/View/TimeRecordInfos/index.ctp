<div class="timeRecordInfos index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $timeRecordInfo['TimeRecordInfo']['id']), array('confirm' => __('[%s] のデータを削除してよろしいですか？', $timeRecordInfo['TimeRecordInfo']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
