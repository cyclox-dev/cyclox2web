<div class="timeRecords index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $timeRecord['TimeRecord']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $timeRecord['TimeRecord']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
