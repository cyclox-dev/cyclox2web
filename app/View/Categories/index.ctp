<div class="categories index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $category['Category']['code']), array('confirm' => __('Are you sure you want to delete # %s?', $category['Category']['code']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
