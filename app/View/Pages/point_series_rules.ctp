...
<p>ポイントシリーズの hint の入力により、所属カテゴリー、jcf ナンバー入力有無で対象選手を制限することができる。</p>
<p>つまり例えば、計算日時点でカテゴリーを持たない選手はランキングに集計されない。昇格してしまった選手を除外する場合などに有効である。</p>
<p>
...
<p>
	JCF ナンバー入力ありの選手のみに制限する場合には hint に</br>
	only_jcfer</br>
	の値を含める。ほかの条件と合わせるならば、</br>
	cat_limit:C1/C2,only_jcfer,race_count:5</br>
	というところ。
<h3>配点ルール</h3>
<?php
