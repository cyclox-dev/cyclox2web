...
| **直接コスト** | | | **15万円** | **1.0%** |
| 　- GitHub Copilot（8ヶ月） | - | $10/月×3名 | 3.6万円 | 0.2% |
| 　- GitHub Organization（8ヶ月） | - | $4/月×3名 | 1.44万円 | 0.1% |
| 　- クラウド開発環境（8ヶ月） | - | $50/月 | 5.8万円 | 0.4% |
| 　- CI/CDパイプライン利用料（8ヶ月） | - | $35/月 | 4.06万円 | 0.3% |
| **総予算** | | | **1,567万円** | **100%** |
...
2. **期間**: 8ヶ月間での完了を想定（並行作業含む）
3. **人員**: 3名のエンジニアチームでの並行作業
...
本プロジェクトは、PHP 5.xとCakePHP 2.xの古い技術スタックから、PHP 8.xとCodeIgniter4という最新の技術スタックへの移行を実現します。総予算1,567万円で、セキュリティ向上、保守性向上、パフォーマンス向上という3つの主要な効果が期待できます。
