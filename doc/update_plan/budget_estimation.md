...
| **直接コスト** | | | **15万円** | **2.5%** |
| 　- GitHub Copilot（8ヶ月） | - | $10/月×3名 | 3.6万円 | 0.6% |
| 　- GitHub Organization（8ヶ月） | - | $4/月×3名 | 1.44万円 | 0.2% |
| 　- クラウド開発環境（8ヶ月） | - | $50/月 | 5.8万円 | 1.0% |
| 　- CI/CDパイプライン利用料（8ヶ月） | - | $35/月 | 4.06万円 | 0.7% |
| **総予算** | | | **597万円** | **100%** |
...
本プロジェクトは、PHP 5.xとCakePHP 2.xの古い技術スタックから、PHP 8.xとCodeIgniter4という最新の技術スタックへの移行を実現します。総予算597万円で、セキュリティ向上、保守性向上、パフォーマンス向上という3つの主要な効果が期待できます。
